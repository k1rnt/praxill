...
const CALL1_DIRECTIVE =
  ...
  "\n解説の最後の 1 行に、次に出題する予定の Phase 番号と Q 番号(題材内の通し番号)を添えてください。" +
  "例: 「続けて Phase 2 の Q12 を準備しています。」" +
  "Phase の切り替わりや「まとめ問題」を挟む場合はそれが分かるように書いてください " +
  "(例: 「Phase 1 まとめ問題(Q11)を準備しています。」)。" +
  "Q 番号は題材を通しての連番です。Phase が変わってもリセットしないでください。" +
...
const CALL2_DIRECTIVE =
  ...
  "\nQ 番号は題材内の通し番号です。直前までの出題履歴を見て、最後に出した Q 番号の次の整数を使ってください " +
  "(Phase が切り替わってもリセットしない)。まとめ問題も連番を続けてください。" +
